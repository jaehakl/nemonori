  ...
  const rows = Object.values(state.league.players)
    .map((player) => {
      ...
      return {
        ...
        plateAppearances: player.seasonStats.plateAppearances,
        hits: player.seasonStats.hits,
        walks: player.seasonStats.walks,
        strikeOuts: player.seasonStats.strikeOuts,
        inningsPitched: player.seasonStats.inningsPitched,
        earnedRuns: player.seasonStats.earnedRuns,
        hitsAllowed: player.seasonStats.hitsAllowed,
        walksAllowed: player.seasonStats.walksAllowed,
        strikeOutsThrown: player.seasonStats.strikeOutsThrown,
        pitchCount: player.seasonStats.pitchCount,
